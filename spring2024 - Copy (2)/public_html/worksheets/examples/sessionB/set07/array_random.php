...
*/
$a=array("red","green","blue","yellow","brown","maroon","pink","white","black");

// if specifying only one, it is not a single keys
// no subscript for the random
$random_key = array_rand($a,1);
echo "single key: $a[$random_key] <br>";

// if specifying more than one, it is an array of keys
// need subscript to retrieve the index value
