...
document.addEventListener("DOMContentLoaded", init, false);
	...
	var newCell, newImg, newLink, myButton;
...
function init() {
	for (r = 0; r <= 5; r++) {
		...
		for (c = 0; c <= 5; c++) {
			...
			//newLink.addEventListener("click", function() {showimage((6*r)+c), false;} );
			myButton = document.mForm.mButton;
			//newLink.onClick = myButton.focus();
		}
	}
